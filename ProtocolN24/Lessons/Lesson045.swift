...
class Lesson045: NSObject, ObservableObject {
    ...
    var lesson045 = Lesson(id: 045, headline: "How to control your weight - III",
                           dayRef: "Day 1 (5/5) - III",
                           module: .week1,
                                                         ...
                                                         UIComponent(type: .uiTextString, uiData: UIData(uiText: """
                                                              ...
                                                              UIComponent(type: .uiTextString, uiData: UIData(uiText: """
                                                                   ...
                                                                   UIComponent(type: .uiImageName, uiData: UIData(uiText: "xx", uiText2: "xx",
                                                                                           uiImage: "BodyWeight7DayAvgIncreasing", ratioOfDeviceWidth: 1, imageRatio: 0.6,
                                                                                                                                                   uiSegPickerOptions: ["xx"])),
                                                              ...
                                                              UIComponent(type: .uiTextString, uiData: UIData(uiText: """
                                                                                                     ...
                                                                                                     So what factors can influence our bodyweight? Let's assume that our training, stress levels and sleep are consistent, we can investigate the biggest influence on our bodyweight: How much food/drink we consume.
